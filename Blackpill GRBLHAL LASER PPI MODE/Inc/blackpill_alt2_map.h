 ...
 *        Laser pulse pin  B2 |           | A8   Spindle PWM
 *        Spindle Enable  B10 |           | B15  A Limit
 *                        +3V |   -----   | B14  Z Limit
 *                        GND |  |     |  | B13  Y Limit
 *                        +5V |  | USB |  | B12  X Limit
 *                             -----------
...
#else
#define BOARD_NAME "BlackPill Alt. 2 PPI LASER EDITION"
#endif
...
#define LASER_PULSE_PORT     GPIOB
#define LASER_PULSE_PIN      2
#else
